            ...
            <div class="journal-checkout">
                <div class="left">
                    ...
                    <div class="checkout-content login-box">
                        <h2 class="secondary-title"><?php echo $this->journal2->settings->get('one_page_lang_register_selector', 'Вход'); ?></h2>
                        <div class="radio">
                            <label>
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <?php echo $this->journal2->settings->get('one_page_lang_returning', 'Авторизиция'); ?>
                            </label>
                        </div>
                    </div>
                    <script>
                    ...
                    <div class="checkout-content checkout-login">
                        <fieldset>
                            <h2 class="secondary-title"><?php echo $this->journal2->settings->get('one_page_lang_returning', 'Оплата'); ?></h2>
                    ...
                    <section class="section-right">
                        ...
                        <div class="checkout-content confirm-section">
                            ...
                            <div class="confirm-order">
                                <button id="journal-checkout-confirm-button" data-loading-text="<?php echo $this->journal2->settings->get('one_page_lang_loading_text', 'Loading..'); ?>" class="button confirm-button"><?php echo $this->journal2->settings->get('one_page_lang_confirm_order', 'Заказать'); ?></button>
                            </div>
                        </div>
                    </section>
                </div>
