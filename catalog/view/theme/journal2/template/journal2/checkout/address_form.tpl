    ...
    <form class="form-horizontal form-<?php echo $type; ?>">
        ...
        <div id="<?php echo $type; ?>-new" style="display: <?php echo($addresses ? 'none' : 'block'); ?>;">
          ...
          <!--  <div class="form-group required">
            ...
            <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-<?php echo $type; ?>-address-1"><?php echo $entry_postcode;; ?></label>

                    <input onkeyup="checkCurr(this)" type="text" name="<?php echo $type; ?>_address_1" value="<?php echo Journal2Utils::getProperty($order_data, $type . '_address_1'); ?>" placeholder="<?php echo $entry_postcode;; ?>"
